...
>>>>>>> 12558073ed8fd7238344bea70474f480f326e839
...
<<<<<<< HEAD
def test_valid_guess_length() :
    assert valid_guess_length('system') == False
    assert valid_guess_length('dog') == True
    assert valid_guess_length('piano') == True
=======
